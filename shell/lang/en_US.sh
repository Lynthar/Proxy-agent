...
MSG_PLAN_CUSTOM_INSTALL="Will enter custom install: install one or more protocols based on later prompts, write inbound config, request TLS certificate (if needed), open firewall ports, and restart core"
